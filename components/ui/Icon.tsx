...
const MAP: Record<string, Entry> = {
  ...
  send: { C: PaperPlaneTilt, weight: "fill" },
  paperclip: { C: Paperclip },
  store: { C: Storefront, weight: "fill" },
  "store-outline": { C: Storefront },
  "trash-can-outline": { C: Trash },
  ...
  "lock-outline": { C: Lock },
  "bell-outline": { C: Bell },
  bell: { C: Bell, weight: "fill" },

  // catalog categories (crisp Phosphor equivalents of the MDI names the API
  // stores; unmapped ones still fall through to MaterialCommunityIcons)
  door: { C: Door },
  "window-open-variant": { C: FrameCorners },
  countertop: { C: CookingPot },
  sofa: { C: Couch },
  "table-furniture": { C: Table },
  bed: { C: Bed },
  grid: { C: GridFour },
  stove: { C: Oven },
  lamp: { C: Lamp },
  "spray-bottle": { C: SprayBottle },
  television: { C: Television },
  "paint-roller": { C: PaintRoller },
  tree: { C: Tree },
  toolbox: { C: Toolbox },
  basket: { C: Basket },
