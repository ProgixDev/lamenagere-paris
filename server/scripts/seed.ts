      ...
      .upsert(
        {
          ...
          price_per_sqm_cents:
            p.pricePerSqm != null ? Math.round(p.pricePerSqm * 100) : null,
          opening_types: (p.openingTypes ?? []).map((o) => ({
            type: o.type,
            surcharge_cents: Math.round(o.surcharge * 100),
          })),
          ...
          min_width: p.minDimensions?.width ?? null,
          min_height: p.minDimensions?.height ?? null,
          max_width: p.maxDimensions?.width ?? null,
          max_height: p.maxDimensions?.height ?? null,
