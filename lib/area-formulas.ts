 ...
 *
 * This module mirrors the server's `common/pricing/area-formulas.ts`. Keep the
 * two in sync: this drives both the inputs shown and the live price preview,
 * and the server re-prices the same way at checkout. If they diverge, the
