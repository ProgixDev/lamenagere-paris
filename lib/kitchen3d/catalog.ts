...
export const MODULES: KitchenModule[] = [
  ...
  {
    id: "bas-four-60",
    label: "Four encastré sous plan 60",
    slot: "bas",
    widthMm: 600,
    depthMm: 600,
    heightMm: GEOM.baseCarcassHeightMm,
  ...
  {
    id: "bas-plaque-chauffante-30",
    label: "Plaque chauffante 30",
    slot: "bas",
    widthMm: 300,
    depthMm: 600,
    heightMm: GEOM.baseCarcassHeightMm,
  ...
  {
    id: "haut-vitre-led-60",
    label: "Porte vitrée LED 60",
    slot: "haut",
    widthMm: 600,
    depthMm: 350,
    heightMm: 700,
  ...
  {
    id: "haut-micro-onde-60",
    label: "Micro-ondes encastré 60",
    slot: "haut",
    widthMm: 600,
    depthMm: 350,
    heightMm: 700,
