...
export const COLORS = {
  ...
  // Crisp gallery white — a whisper-cool near-white paper so the pure-white
  // cards still lift (helped by a soft shadow), with a clean cool-neutral
  // ramp. No warmth. Hierarchy comes from shadow, spacing and typography.
  background: "#FAFBFC",
  surface: "#FAFBFC",
