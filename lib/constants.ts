...
export const COLORS = {
  ...
  secondary: "#002444",
  secondaryContainer: "#dbe8f5",
  // Warm off-white "showroom" neutrals (was cool clinical greys) — gives the
  // whole signed-in app a softer, more premium light. Cards stay pure white so
  // they lift off the warm background without needing muddy borders.
  background: "#FAF8F4",
  surface: "#FAF8F4",
  surfaceContainer: "#EFEAE1",
